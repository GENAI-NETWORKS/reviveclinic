...
const PSYCHIATRY_SERVICES = [
  ...
  { id: 'psy-10', title: 'ADHD Assessment & Treatment', desc: 'Attention Deficit Hyperactivity Disorder (ADHD) is a neurodevelopmental condition that can affect both children and adults. Common symptoms include difficulty sustaining attention, forgetfulness, disorganization, impulsivity, restlessness, and difficulty completing tasks. Appropriate treatment can significantly improve concentration and quality of life. We provide detailed ADHD assessment and evidence-based treatment.' },
  ...
  { id: 'psy-12', title: 'Dissociative Disorders Treatment', desc: 'Dissociative disorders involve disruptions in memory, awareness, identity, emotions, or perception often associated with overwhelming stress or psychological trauma. Symptoms may include memory gaps, feeling detached from oneself, feeling disconnected from surroundings, trance-like episodes, or unexplained changes in behaviour. We provide confidential assessment, counselling, and evidence-based treatment.' },
  ...
  { id: 'psy-16', title: 'Behavioural Addiction Treatment', desc: [
